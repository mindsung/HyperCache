...
{
    public abstract class DualStateBase<TObject, TSerialized> : IDualState<TObject, TSerialized>
    {
        protected DualStateBase(ISerializationProvider<TSerialized> serializer)
        {
    ...
    public abstract class DualStateBase<TObject> : DualStateBase<TObject, string>, IDualState<TObject>
    {
        protected DualStateBase(ISerializationProvider<string> serializer)
            : base(serializer)
        {
        }
    }
